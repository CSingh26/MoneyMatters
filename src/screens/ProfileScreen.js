    ...
    <SafeAreaView style={[styles.page, { backgroundColor: colors.bgPrimary }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.avatarCard, { backgroundColor: colors.cardBg, borderColor: colors.cardBorder }]}>
          ...
          <Text style={[styles.avatarName, { color: colors.gray800 }]}>{user?.name}</Text>
        ...
        <View style={[styles.card, { backgroundColor: colors.cardBg, borderColor: colors.cardBorder }]}>
          ...
          <View style={styles.statsRow}>
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: accentColor }]}>${financialSummary.totalBalance.toLocaleString()}</Text>
              <Text style={[styles.statLabel, { color: colors.gray500 }]}>Balance</Text>
            </View>
            <View style={[styles.statDivider, { backgroundColor: colors.gray100 }]} />
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: colors.success }]}>{financialSummary.savingsRate}%</Text>
              <Text style={[styles.statLabel, { color: colors.gray500 }]}>Savings Rate</Text>
            </View>
            <View style={[styles.statDivider, { backgroundColor: colors.gray100 }]} />
            <View style={styles.statItem}>
              <Text style={[styles.statValue, { color: colors.gray800 }]}>${financialSummary.monthlyIncome.toLocaleString()}</Text>
